...
class VersatileDiffusionDualGuidedFromCLIPEmbeddingPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        **kwargs,
        ...
        fake_prompt_embeds = self._encode_text_prompt(prompt, device, num_images_per_prompt, do_classifier_free_guidance)
        fake_image_embeddings = self._encode_image_prompt(image, device, num_images_per_prompt, do_classifier_free_guidance)
        
        prompt_types = ("text", "image")
        
        ### REPLACE prompt and image with real embeddings
        
        prompt_embeds= brain_txt_embeds
        image_embeddings = brain_img_embdes
